public class Variable1
{
    ...
    static int age = 2; //this is static global variable---------||||| for static variable will be allocated memory
    final int j = 20; // this is constant variable
    
    void display()
    {
        age = 32;
        int c; //local variable do not have default value as compiler will not initialize value to it
        int y = 5; //local ariable
     ...
     boolean tim = (pass && name);
     System.out.println(" the result are " + tim);
    // this will give out error  " System.out.println(c);"
    }
